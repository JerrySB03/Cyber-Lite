  ...
  const updateText = () => {
    if (currentIndex < originalText.length) {
      ...
      if (currentIndex < originalText.length + currentWord.length) {
        magictext = originalText + currentWord.slice(0, currentIndex - originalText.length + 1);
        currentIndex++;
      } else {
...
<nav>
  ...
  <div class="div-topText">
    <p
      style="border-radius: 20px; border-width:3px; border-style:solid; border-color: #7C7C7C; padding: 0em; "
      class="line"
    />
    ...
    <p style="font-family: Ubuntu">
      ...
      id magna semper rutrum. In dapibus augue non sapien. Sed ac dolor sit amet
      purus malesuada congue. Maecenas fermentum, sem in pharetra.
    </p>
  </div>
  ...
  <div class="div-bottomText" style="font-family: U;">
    ...
    <p>
      ...
      tellus odio, dapibus id fermentum quis, suscipit id erat. In dapibus augue
      non sapien. Vivamus luctus egestas leo. Integer in sapien. Vivamus luctus
      egestas leo. Nullam faucibus mi quis velit. Temporibus autem quibusdam et
