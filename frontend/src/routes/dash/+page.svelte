<script>
    ...
    const data = [
      ...
      { name: 'Lorem Ipsum', des: 'Lorem ipsum dolor sit amet', link: '/blogpost/loremipsum' },
      { name: 'Svelte', des: 'A magical framework', link: '/blogpost/svelte' }
      // Add more objects to the data array
    ];
...
<nav>
  ...
  <div class="search-bar" style="width: {searchBarWidth}px;">
    <input type="text" bind:value={searchTerm} placeholder="Enter your search term" on:input={handleSearch} />
  ...
  <style> 
   .search-container {
    ...
    width: calc(100% - 600px); /* Adjust the 400px value as needed */
